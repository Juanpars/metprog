Algoritmo indica_mes
	Escribir"****Juan pablo ramirez Salazar****";
	Escribir "Algoritmo Indica que indica el mes";
	Escribir "";
	Definir mes Como Entero;
	Escribir"Ingresar día del mes con numero";
	Leer mes;
	Segun mes Hacer
		1:
			Escribir  "Enero es el primer mes del año en el calendario gregoriano";
			Escribir "y tiene 31 días.";
		2:
			Escribir "Febrero es el segundo mes del año en el calendario gregoriano.";
